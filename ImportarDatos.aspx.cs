...
public partial class ImportarDatos : System.Web.UI.Page
{
    ...
    public void inicia()
    {
        try
        {
            ...
            conectar.ConnectionString = (@"Data Source=DESKTOP-R2G678A\SQLEXPRESS;Initial Catalog=Alfanet; User Id=sa;Password=1010");
            conectar.Open();
        }
        catch
        {
    ...
    {
        string cadena = @"Data Source=DESKTOP-R2G678A\SQLEXPRESS;Initial Catalog=alfanet; User Id=sa;Password=1010";
    ...
    private void GuardarArchivo(HttpPostedFile file)
    {
        ...
        conn.ConnectionString = (@"Data Source=DESKTOP-R2G678A\SQLEXPRESS;Initial Catalog=alfanet; User Id=sa;Password=1010");
        {
