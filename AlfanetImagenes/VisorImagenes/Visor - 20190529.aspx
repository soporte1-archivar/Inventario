...
<contenttemplate>
<TABLE style="WIDTH: 200%"><TBODY><TR><TD style="WIDTH: 32647px"><asp:Label id="LblDocumentoNro" runat="server" Width="110px" Font-Size="Small" ForeColor="Red" Text="Label" Font-Bold="True">
</asp:Label> </TD><TD><IMG id="imgclip" runat="server" src="../../AlfaNetImagen/ToolBar/file.gif" /> </TD><TD style="WIDTH: 339px"><asp:FileUpload id="FileUpload1" runat="server" Width="420px">
